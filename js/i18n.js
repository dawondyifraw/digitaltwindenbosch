window.udtI18n = (function () {
    const translations = {
        nl: {
            ...
            demo_chat_active: "Beperkte versie actief. Bezoek DataTwinLabs.nl om een real-time full-data demo en event in te plannen met Daniel of Prof. Jos.",
            demo_chat_traffic: "Deze beperkte versie toont alleen een deel van de verkeerslaag. Bezoek DataTwinLabs.nl om een real-time full-data demo en event in te plannen met Daniel of Prof. Jos.",
            demo_chat_air: "Deze beperkte versie toont voorbeeldinzichten. Bezoek DataTwinLabs.nl om een real-time full-data demo en event in te plannen met Daniel of Prof. Jos.",
            demo_chat_default: "Dit is de beperkte versie van de Digital Twin Den Bosch-ervaring. Bezoek DataTwinLabs.nl om een real-time full-data demo en event in te plannen met Daniel of Prof. Jos voor het volledige multi-streaming platform.",
            demo_chat_error: "Deze beperkte versie gebruikt niet alle backenddiensten. Bezoek DataTwinLabs.nl om een real-time full-data demo en event in te plannen met Daniel of Prof. Jos.",
            ...
            briefing_text: "Beperkte versie. Bezoek DataTwinLabs.nl om een real-time full-data demo en event in te plannen met Daniel of Prof. Jos voor het volledige multi-streaming platform en de gemeentelijke uitrolroadmap.",
        ...
        en: {
            ...
            demo_chat_active: "Limited version active. Visit DataTwinLabs.nl to schedule a real-time full-data demo and event with Daniel or Prof. Jos.",
            demo_chat_traffic: "This limited version shows only part of the traffic layer. Visit DataTwinLabs.nl to schedule a real-time full-data demo and event with Daniel or Prof. Jos.",
            demo_chat_air: "This limited version shows sample insights. Visit DataTwinLabs.nl to schedule a real-time full-data demo and event with Daniel or Prof. Jos.",
            demo_chat_default: "This is the limited version of the Digital Twin Den Bosch experience. Visit DataTwinLabs.nl to schedule a real-time full-data demo and event with Daniel or Prof. Jos for the full multi-streaming platform.",
            demo_chat_error: "This limited version does not use all backend services. Visit DataTwinLabs.nl to schedule a real-time full-data demo and event with Daniel or Prof. Jos.",
            ...
            briefing_text: "Limited version. Visit DataTwinLabs.nl to schedule a real-time full-data demo and event with Daniel or Prof. Jos for the full multi-streaming platform and municipal deployment roadmap.",
